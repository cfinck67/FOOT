...
typedef struct {
  ...
  Int_t    DCHicell[MAXDCH];		
  Int_t    DCHiview[MAXDCH];		
  Double_t DCHxin[MAXDCH];		
  Double_t DCHyin[MAXDCH];		
  Double_t DCHzin[MAXDCH];		
  Double_t DCHxout[MAXDCH];		
  Double_t DCHyout[MAXDCH];		
  Double_t DCHzout[MAXDCH];		
  Double_t DCHpxin[MAXDCH];		
  Double_t DCHpyin[MAXDCH];		
  Double_t DCHpzin[MAXDCH];		
  Double_t DCHpxout[MAXDCH];		
  Double_t DCHpyout[MAXDCH];		
  Double_t DCHpzout[MAXDCH];		
  Double_t DCHde[MAXDCH];		
  Double_t DCHal[MAXDCH];		
  Double_t DCHtim[MAXDCH];      
