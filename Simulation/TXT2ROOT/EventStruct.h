...
typedef struct {
  ...
  Int_t icell[MAXBM];
  Int_t iview[MAXBM];
  Double_t xinmon[MAXBM];
  Double_t yinmon[MAXBM];
  Double_t zinmon[MAXBM];
  Double_t xoutmon[MAXBM];
  Double_t youtmon[MAXBM];
  Double_t zoutmon[MAXBM];
  Double_t pxinmon[MAXBM];
  Double_t pyinmon[MAXBM];
  Double_t pzinmon[MAXBM];
  Double_t pxoutmon[MAXBM];
  Double_t pyoutmon[MAXBM];
  Double_t pzoutmon[MAXBM];
  Double_t demon[MAXBM];
  Double_t almon[MAXBM];
  Double_t timmon[MAXBM];
  ...
  Int_t irowIT[MAXIT];
  Int_t icolIT[MAXIT];
  Double_t xinIT[MAXIT];
  Double_t yinIT[MAXIT];
  Double_t zinIT[MAXIT];
  Double_t xoutIT[MAXIT];
  Double_t youtIT[MAXIT];
  Double_t zoutIT[MAXIT];
  Double_t pxinIT[MAXIT];
  Double_t pyinIT[MAXIT];
  Double_t pzinIT[MAXIT];
  Double_t pxoutIT[MAXIT];
  Double_t pyoutIT[MAXIT];
  Double_t pzoutIT[MAXIT];
  Double_t deIT[MAXIT];
  Double_t alIT[MAXIT];
  Double_t timIT[MAXIT];
