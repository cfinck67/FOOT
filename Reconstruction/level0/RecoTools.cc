...
void RecoTools::RecoLoop(TAGroot *tagr, int fr) {
  ...
  */
  ...
  if(m_doBM) {
    ...
    m_bmgeo = shared_ptr<TABMparGeo> ( (TABMparGeo*) myp_bmgeo->Object() );
    m_bmgeo->InitGeo();
    m_bmgeo->ShiftBmon();
  ...
  if(m_doTW) {
    ...
    m_twgeo = shared_ptr<TATWparGeo> ( (TATWparGeo*) myp_twgeo->Object() );
  ...
  if(m_doCA) {
    ...
    m_cageo = shared_ptr<TACAparGeo> ( (TACAparGeo*) myp_cageo->Object() );
...
void RecoTools::FillMCTofWall(EVENT_STRUCT *myStr) {
  ...
  myn_twraw    = new TAGdataDsc("twraw", new TATWdatRaw());
...
void RecoTools::FillMCCalorimeter(EVENT_STRUCT *myStr) {
  ...
  myn_caraw    = new TAGdataDsc("caraw", new TACAdatRaw());
...
void RecoTools::FillMCInteractionRegion(EVENT_STRUCT *myStr) {
  ...
  /*Ntupling the MC Beam Monitor information*/
  myn_irraw    = new TAGdataDsc("irraw", new TAIRdatRaw());
  myp_irgeo    = new TAGparaDsc("irGeo", new TAIRparGeo());
