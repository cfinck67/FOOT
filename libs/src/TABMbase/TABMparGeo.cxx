...
//   TGeoManager *bm_geo=new TGeoManager("bm_geo", "geometria beam monitor");
  new TGeoManager("bm_geo", "geometria beam monitor");
  
  //roba che per ora copio in maniera becera da makeGeom.C per vedere se cosi funzia..
...
//qua provo a togliere box di area_gas e mettere solo top al suo posto...
   ...
   /* provo un attimo a togliere i fili...
   //create wires  
