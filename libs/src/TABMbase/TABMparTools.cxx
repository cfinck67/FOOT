...
#include "TABMparTools.hxx"

//##############################################################################

/*!
  \class TABMparTools TABMparTools.hxx "TABMparTools.hxx"
  \brief tools parameters for vertex. **
*/

ClassImp(TABMparTools);

//______________________________________________________________________________
TABMparTools::TABMparTools()
: TAGpara(),
  fFileStream(),
  fFileName(),
  fDebugLevel(0)
...
void TABMparTools::ReadItem(TString& item)
{
   Int_t pos = -1;
   Char_t buf[255];
   TString key;
...
//_____________________________________________________________________________
void TABMparTools::ReadItem(Int_t &arg)
{
   TString item;
   ReadItem(item);
   arg = item.Atoi();
...
//_____________________________________________________________________________
void TABMparTools::ReadItem(Float_t &arg)
{
   TString item;
   ReadItem(item);
   arg = item.Atof();
...
//_____________________________________________________________________________
void TABMparTools::ReadItem(Float_t* coeff, Int_t size,  const Char_t delimiter)
{
   TString key;
   ReadItem(key);
...
//_____________________________________________________________________________
void TABMparTools::ReadVector3(TVector3 &arg)
{
...
//_____________________________________________________________________________
void TABMparTools::ReadStrings(Char_t *aString, Int_t aLength)
{
   ...
   if (end == -1 || pos == -1 || end-pos-1 > aLength) {
	  cout << "TABMparGeo: problem with reading configuration file, missing \" or line too long" << endl; 
	  return;
   }
...
//_____________________________________________________________________________
TString TABMparTools::Normalize(const char* line)
{
...
//______________________________________________________________________________
Bool_t TABMparTools::Open(const TString& name) 
{
   // openning file
