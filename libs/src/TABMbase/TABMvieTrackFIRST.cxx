/*!
  \file
  \version $Id: TABMvieTrackFIRST.cxx,v 1.7 2003/06/22 19:35:02 mueller Exp $
  \brief   Implementation of TABMvieTrackFIRST.
*/
...
/*!
  \class TABMvieTrackFIRST TABMvieTrackFIRST.hxx "TABMvieTrackFIRST.hxx"
  \brief Horizontal projective view for TABMntu*CHitQad and TABMntu*CTrackQad **
*/

ClassImp(TABMvieTrackFIRST);

//------------------------------------------+-----------------------------------
//! Construct with observables.

TABMvieTrackFIRST::TABMvieTrackFIRST(TAGdataDsc* p_ntutrk,
					     TAGdataDsc* p_nturaw,
					     TAGparaDsc* p_bmgeo)
  : fpNtuTrk(p_ntutrk),
    fpNtuRaw(p_nturaw),
    fpParBMGeo(p_bmgeo)
{
  ...
  SetName("TABMvieTrackFIRST");
  SetTitle("TABMvieTrackFIRST");
}

//------------------------------------------+-----------------------------------
//! Destructor.

TABMvieTrackFIRST::~TABMvieTrackFIRST()
{
}
...
char* TABMvieTrackFIRST::GetObjectInfo(Int_t i_px, Int_t i_py) const
{
  if (!gPad) return (char*)"";
...
void TABMvieTrackFIRST::ExecuteEvent(Int_t i_event, Int_t i_px, Int_t i_py)
{
...
void TABMvieTrackFIRST::Paint(Option_t* option)
{
