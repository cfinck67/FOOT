...
Bool_t TABMparCon::FromFile(const TString& name) {
  ...
  strel_2mine.SetParameters(0 , 0.0150799 , -0.000468695 , 9.55425e-06 , -1.04953e-07 , 6.13249e-10 , -1.61655e-12 , -7.08514e-16 , 1.54662e-17 , -3.56961e-20 , 2.73837e-23 );
  //strel_3mine
  ...
  strel_3mine=TF1("strel_3mine","[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+ (0.8-300.*[1]-90000.*[2]-27000000.*[3]-8100000000.*[4])/2430000000000.*x*x*x*x*x", 0., 300.);
  strel_3mine.SetParameters(0 , 0.00899255 , -5.61645e-05 , 7.57411e-08 , 5.22026e-10);
  //strel_4hit
  ...
  //~ bmwire_disp={-0.13438446438217924 , 0.047884193373044136 , 0.2244742169074212 ,  0 ,  0 ,  0 , -0.24012762464217327 , -0.044916494427145313 , 0.15227627688107265 ,  0 ,  0 ,  0 , -0.14011131001904192 , 0.050855847013433611 , 0.25316076536588938 ,  0 ,  0 ,  0 , -0.25062020149765935 , -0.047190295460242719 , 0.15949921462478303 ,  0 ,  0 ,  0 , -0.14342868959167215 , 0.053881664899008239 , 0.26847763545997183 ,  0 ,  0 ,  0 , -0.25724976608408506 , -0.047026341366008549 , 0.16235004156063004 ,  0 ,  0 ,  0  };
...
Double_t TABMparCon::ResoEvalDist(Double_t dist) {
  //~ return 0.001;
  Double_t sigma;
  Int_t mybin(-1);
  if(my_hreso) {
