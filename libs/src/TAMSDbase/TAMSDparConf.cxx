...
TString TAMSDparConf::fgkDefaultConfName = "./config/TAMSDdetector.cfg";
 Bool_t TAMSDparConf::fgIsMapHist       = false;
...
//------------------------------------------+-----------------------------------
//! Clear geometry info.
void TAMSDparConf::Clear(Option_t*)
{
  return;
}
...
/*------------------------------------------+---------------------------------*/
//! ostream insertion.
void TAMSDparConf::ToStream(ostream& os, Option_t*) const
{
//  os << "TAMSDparConf " << GetName() << endl;
