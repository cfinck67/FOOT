// @(#)maf/dtools:$Name:  $:$Id: TAITntuAlign.h,v.1 2005/10/02 18:03:46 sha Exp $
// Author: Dirk Meier   97/01/20 

#ifndef _TAITntuAlign_HXX
#define _TAITntuAlign_HXX
...
/** TAITntuAlign class book keeping for alignment
 
    \author Dirk Meier
 */

class TAITntuAlign : public TAGdata {
...
public:
   TAITntuAlign();                                 
   TAITntuAlign(Int_t aPlaneNumber);                                 
   ~TAITntuAlign();
   ...
   ClassDef(TAITntuAlign,1)           // book keeping for alignment 
};
