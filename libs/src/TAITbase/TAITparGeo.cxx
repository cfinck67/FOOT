...
/*!
  \class TAITparGeo TAITparGeo.hxx "TAITparGeo.hxx"
  \brief Map and Geometry parameters for Tof wall. **
*/

ClassImp(TAITparGeo);

TString TAITparGeo::fgkDefaultGeoName   = "./geomaps/TAITdetector.map";
TString TAITparGeo::fgkDefaultGeoNameMC = "./geomaps/TAITdetectorMC.map";
Float_t TAITparGeo::fgTargetWidth       =  8000.;
Float_t TAITparGeo::fgTargetSize        =  20000.;

//______________________________________________________________________________
TAITparGeo::TAITparGeo()
: TAITparTools(),
  fMatrixList(new TObjArray(TAITparMap::GetSensorsN())),
...
//______________________________________________________________________________
Bool_t TAITparGeo::FromFile(const TString& name) 
{   
...
//_____________________________________________________________________________
TVector3* TAITparGeo::GetPosition(Int_t iSensor)
{
...
//_____________________________________________________________________________
void TAITparGeo::Global2Local(Int_t detID,
...
//_____________________________________________________________________________
TVector3 TAITparGeo::Global2Local(Int_t detID, TVector3& glob) const
{
   if (detID < 0 || detID > GetSensorsN()) {
	  cout << "Wrong detector id number" << endl; 
...
//_____________________________________________________________________________
TVector3 TAITparGeo::Global2LocalVect(Int_t detID, TVector3& glob) const
{
   if (detID < 0 || detID > GetSensorsN()) {
...
//_____________________________________________________________________________
void TAITparGeo::Local2Global(Int_t detID,
...
//_____________________________________________________________________________
TVector3 TAITparGeo::Local2Global(Int_t detID, TVector3& loc) const
{
   if (detID < 0 || detID > GetSensorsN()) {
	  cout << "Wrong detector id number" << endl; 
	  TVector3(0,0,0);
...
//_____________________________________________________________________________
TVector3 TAITparGeo::Local2GlobalVect(Int_t detID, TVector3& loc) const
{
   if (detID < 0 || detID > GetSensorsN()) {
