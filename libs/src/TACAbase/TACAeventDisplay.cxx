...
#ifndef _TACAeventDisplay_HXX_
#include "TACAeventDisplay.hxx"
#endif
...
ClassImp(TACAeventDisplay)

TACAeventDisplay* TACAeventDisplay::fgInstance = 0x0;

//__________________________________________________________
TACAeventDisplay* TACAeventDisplay::Instance(const TString name)
{
   if (fgInstance == 0x0) 
	  fgInstance = new TACAeventDisplay(name);

   return fgInstance;
}

//__________________________________________________________
TACAeventDisplay::TACAeventDisplay(const TString name)
...
//__________________________________________________________
TACAeventDisplay::~TACAeventDisplay()
{
   // default destructor
...
//__________________________________________________________
void TACAeventDisplay::CreateRawAction()
{
   TAVTeventDisplay::CreateRawAction();

   //CA & BM dsc
   fpTrMap = new TAGparaDsc("trMap", new TATRparMap());
   fpIrMap = new TAGparaDsc("irMap", new TACAparMap());
   ...
   //CA map
   Bool_t b_bad = kTRUE;
   TACAparMap* pirMap = (TACAparMap*) fpIrMap->Object();
   pirMap->Clear();
   ...
   filename = "./config/file_stlist_FCAST.txt";	  
   ...
   fpIrRaw = new TAGdataDsc("irRaw", new TACAdatRaw());
   ...
   fActIrRaw = new TACAactDatRaw("irActRaw", fpIrRaw, fpEvent, fpIrMap);
...
//__________________________________________________________
void TACAeventDisplay::CreateRecAction()
{
   // BM
...
//__________________________________________________________
void TACAeventDisplay::BuildDefaultGeometry()
{
...
//__________________________________________________________
void TACAeventDisplay::CreateCanvases()
{
...
//__________________________________________________________
void TACAeventDisplay::UpdateDefCanvases()
{
...
void TACAeventDisplay::DrawReco()
{
...
//__________________________________________________________
void TACAeventDisplay::AddElements()
{
...
//__________________________________________________________
void TACAeventDisplay::ConnectElements()
{  
   TAVTeventDisplay::ConnectElements();

   fBmTrackDisplay->SetEmitSignals(true);
   fBmTrackDisplay->Connect("SecSelected(TEveDigitSet*, Int_t )", "TACAeventDisplay", this, "UpdateBmInfo(TEveDigitSet*, Int_t)");
   
   fKeTrackDisplay->SetEmitSignals(true);
   fKeTrackDisplay->Connect("SecSelected(TEveDigitSet*, Int_t )", "TACAeventDisplay", this, "UpdateKeInfo(TEveDigitSet*, Int_t)");
}

//__________________________________________________________
void TACAeventDisplay::UpdateBmInfo(TEveDigitSet* qs, Int_t idx)
{
...
//__________________________________________________________
void TACAeventDisplay::UpdateKeInfo(TEveDigitSet* qs, Int_t idx)
{
   TAGtrackDisplay* lineTracks = dynamic_cast<TAGtrackDisplay*> (qs);   
...
//__________________________________________________________
void TACAeventDisplay::UpdateElements()
{      
...
//__________________________________________________________
void TACAeventDisplay::AddRequiredItem()
{
   //BM
