...
class TAKEtrack;
/** TACAeventDisplay a class to work on the raw event display
 
 */
class TACAeventDisplay : public TAVTeventDisplay
{
   
private:
   static TACAeventDisplay* fgInstance; // static instance of class
   
public:
   //! Instance of class
   static TACAeventDisplay* Instance(const TString name = "provaout0020.lmd");  
   
public:   
   virtual ~TACAeventDisplay();
...
protected:
   TACAeventDisplay(const TString name);
...
protected:
   ...
   TAGaction*      fActIrRaw;       // Action CA raw
   ...
   TAGparaDsc*     fpIrMap;		    // parameter map CA  
