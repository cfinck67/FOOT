...
/*!
  \class TACAparTools TACAparTools.hxx "TACAparTools.hxx"
  \brief tools parameters for vertex. **
*/

ClassImp(TACAparTools);

//______________________________________________________________________________
TACAparTools::TACAparTools()
: TAGpara(),
  fFileStream(),
  fFileName(),
  fDebugLevel(0)
...
void TACAparTools::ReadItem(TString& item)
{
   Int_t pos = -1;
   Char_t buf[255];
   TString key;
...
//_____________________________________________________________________________
void TACAparTools::ReadItem(Int_t &arg)
{
   TString item;
   ReadItem(item);
   arg = item.Atoi();
...
//_____________________________________________________________________________
void TACAparTools::ReadItem(Float_t &arg)
{
   TString item;
   ReadItem(item);
   arg = item.Atof();
...
//_____________________________________________________________________________
void TACAparTools::ReadItem(Float_t* coeff, Int_t size,  const Char_t delimiter)
{
   TString key;
   ReadItem(key);
...
//_____________________________________________________________________________
void TACAparTools::ReadVector3(TVector3 &arg)
{
...
//_____________________________________________________________________________
void TACAparTools::ReadStrings(Char_t *aString, Int_t aLength)
{
   ...
   if (end == -1 || pos == -1 || end-pos-1 > aLength) {
	  cout << "TACAparGeo: problem with reading configuration file, missing \" or line too long" << endl; 
	  return;
   }
...
//_____________________________________________________________________________
TString TACAparTools::Normalize(const char* line)
{
...
//______________________________________________________________________________
Bool_t TACAparTools::Open(const TString& name) 
{
   // openning file
