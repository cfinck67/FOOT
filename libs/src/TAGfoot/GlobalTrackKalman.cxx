...
double GlobalTrackKalman::EvalError( TVector3 mom, TVector3 err ) {
...
double GlobalTrackKalman::EvalError( TVector3 mom, TMatrixD cov ) {
...
//----------------------------------------------------------------------------------------------------
void GlobalTrackKalman::PrintPositionResidual( TVector3 pos, TVector3 expectedPos, string hitSampleName ) {
...
//----------------------------------------------------------------------------------------------------
void GlobalTrackKalman::PrintMomentumResidual( TVector3 meas, TVector3 expected, TVector3 cov, string hitSampleName ) {
...
//----------------------------------------------------------------------------------------------------
void GlobalTrackKalman::PrintMomentumResidual( TVector3 meas, TVector3 expected, TMatrixD cov, string hitSampleName ) {
...
//----------------------------------------------------------------------------------------------------
void GlobalTrackKalman::PrintMomentumResidual( TVector3 meas, TVector3 expected, double err, string hitSampleName ) {
...
//----------------------------------------------------------------------------------------------------
// Called from outside!
void GlobalTrackKalman::EvaluateMomentumResolution() {
