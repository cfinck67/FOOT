/*!
  \file
  \version $Id: adapted from TABMactDatRaw.cxx,v 1.5 2003/06/22 10:35:47 mueller Exp $
  \brief   Implementation of TADCactDatRaw.
*/

#include "TADCparMap.hxx"
#include "TADCparCon.hxx"
#include "TAGmbsEvent.hxx"
#include "TADCdatRaw.hxx"

#include "TADCactDatRaw.hxx"
#include <iomanip>

/*!
  \class TADCactDatRaw TADCactDatRaw.hxx "TADCactDatRaw.hxx"
  \brief Get Drift Chamber raw data from MBS. **
*/

ClassImp(TADCactDatRaw);

//------------------------------------------+-----------------------------------
//! Default constructor.

TADCactDatRaw::TADCactDatRaw(const char* name,
			     TAGdataDsc* p_datraw, 
			     TAGdataDsc* p_datmbs,
			     TAGparaDsc* p_parmap,
			     TAGparaDsc* p_parcon)
  : TAGaction(name, "TADCactDatRaw - Unpack DC raw data"),
    fpDatRaw(p_datraw),
    fpDatMbs(p_datmbs),
    fpParMap(p_parmap),
    fpParCon(p_parcon)
{
  AddDataOut(p_datraw, "TADCdatRaw");
  AddDataIn(p_datmbs, "TAGmbsEvent");
  AddPara(p_parmap, "TADCparMap");
...
TADCactDatRaw::~TADCactDatRaw()
{}

//------------------------------------------+-----------------------------------
//! Action.

Bool_t TADCactDatRaw::Action() {
  ...
  TADCparMap*    p_parmap = (TADCparMap*)    fpParMap->Object();
