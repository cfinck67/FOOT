/*!
  \file
  \version $Id: adapted from TABMparMap.cxx,v 1.5 2003/06/09 18:41:04 mueller Exp $
  \brief   Implementation of TADCparMap.
*/
...
/*!
  \class TADCparMap TADCparMap.hxx "TADCparMap.hxx"
...
Bool_t TADCparMap::FromFile(const TString& name) {
...
void TADCparMap::Clear(Option_t*)
{
  TAGpara::Clear();
  chaID.clear();   
  chaBoID.clear();   
...
Bool_t TADCparMap::CheckWire(Int_t i_wire) const
{
...
Bool_t TADCparMap::CheckAddr(Int_t i_c) const
{
...
/*------------------------------------------+---------------------------------*/
bool TADCparMap::GetWireIDFromTDC(int channel, int board, int &senseID, int &plane, int &view) {
