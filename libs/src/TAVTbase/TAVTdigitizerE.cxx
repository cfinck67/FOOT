...
Bool_t TAVTdigitizerE::MakeCluster(Double_t x0, Double_t y0, Double_t /*zin*/, Double_t /*zout*/)
{
   ...
   Float_t x1  = pGeoMap->GetColumnCenter_sensorFrame(col1);
   Float_t y1  = pGeoMap->GetRowCenter_sensorFrame(line1);
   
   // x2 - y2
   Int_t col2  = col0  + sigma;
   Int_t line2 = line0 - sigma;
   
   Float_t x2  = pGeoMap->GetColumnCenter_sensorFrame(col2);
   Float_t y2  = pGeoMap->GetRowCenter_sensorFrame(line2);
